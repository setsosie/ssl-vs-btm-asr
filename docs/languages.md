...
Thirty-two of the 64 carry no `normalizer:` yet: the fourteen Common Voice
languages that entered when the training statistic changed, and all eighteen
new ones. Their policies land separately, and the policy column below is `—`
for them. A preset entry with no policy loads normally and fails a run at
policy resolution, naming the language; the alternative, a placeholder policy
name, would make the preset itself unloadable.

Six of the eighteen bring a script the text layer has never seen — Tibetan,
Sinhala, Kannada, Bengali, Armenian and Hangul — which for a character-CTC model
also grows the output layer.
...
| locale | language | family | script | corpus | trainable h | train h | dev h | test h | validated h | included | reason |
|---|---|---|---|---|---|---|---|---|---|---|---|
| ca | Catalan | Indo-European (Romance) | Latn | common_voice_25 | 3312.4 | 1758.3 | 23.7 | 23.7 | 3359.8 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ps | Pashto | Indo-European (Iranian) | Arab | common_voice_25 | 3008.0 | 239.0 | 16.9 | 16.9 | 3041.9 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| en | English | Indo-European (Germanic) | Latn | common_voice_25 | 2703.6 | 1679.0 | 24.0 | 24.0 | 2751.6 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| rw | Kinyarwanda | Atlantic-Congo (Bantu) | Latn | common_voice_25 | 1956.8 | 1395.1 | 22.2 | 22.5 | 2001.6 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| be | Belarusian | Indo-European (Slavic) | Cyrl | common_voice_25 | 1773.7 | 462.9 | 21.1 | 21.1 | 1816.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| hr | Croatian | Indo-European (Slavic) | Latn | parlaspeech_hr | 1452.8 | 0.0 | 181.6 | 181.6 | 1816.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| eo | Esperanto | Constructed | Latn | common_voice_25 | 1390.7 | 244.6 | 25.2 | 25.2 | 1441.1 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| de | German | Indo-European (Germanic) | Latn | common_voice_25 | 1341.4 | 908.4 | 23.7 | 23.7 | 1388.8 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| et | Estonian | Uralic (Finnic) | Latn | taltech_estonian | 1334.0 | 1334.0 | 21.0 | 23.0 | 0.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| fr | French | Indo-European (Romance) | Latn | common_voice_25 | 1050.5 | 858.1 | 22.7 | 22.7 | 1095.9 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| es | Spanish | Indo-European (Romance) | Latn | common_voice_25 | 550.2 | 485.7 | 21.6 | 21.6 | 593.3 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| kab | Kabyle | Afro-Asiatic (Berber) | Latn | common_voice_25 | 542.9 | 141.6 | 13.9 | 13.9 | 570.7 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| eu | Basque | Isolate | Latn | common_voice_25 | 427.7 | 203.1 | 22.4 | 22.4 | 472.4 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ug | Uyghur | Turkic (Karluk) | Arab | common_voice_25 | 402.2 | 209.4 | 24.2 | 24.2 | 450.6 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| lg | Luganda | Atlantic-Congo (Bantu) | Latn | common_voice_25 | 393.9 | 114.2 | 21.5 | 21.5 | 436.8 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| sw | Swahili | Atlantic-Congo (Bantu) | Latn | common_voice_25 | 356.4 | 68.1 | 17.9 | 17.9 | 392.1 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ja | Japanese | Japonic | Jpan | common_voice_25 | 349.5 | 24.4 | 11.2 | 11.2 | 371.9 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| fa | Persian | Indo-European (Iranian) | Arab | common_voice_25 | 349.5 | 33.0 | 11.7 | 11.7 | 372.9 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| it | Italian | Indo-European (Romance) | Latn | common_voice_25 | 317.1 | 261.9 | 22.9 | 22.9 | 362.9 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| kn | Kannada | Dravidian | Knda | slr126_kannada | 280.0 | 0.0 | 35.0 | 35.0 | 350.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| su | Sundanese | Austronesian (Malayo-Polynesian) | Latn | slr36_sundanese | 266.4 | 0.0 | 33.3 | 33.3 | 333.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| gl | Galician | Indo-European (Romance) | Latn | common_voice_25 | 265.7 | 256.2 | 21.1 | 21.2 | 308.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| kk | Kazakh | Turkic (Kipchak) | Cyrl | slr102_ksc_kazakh | 265.6 | 0.0 | 33.2 | 33.2 | 332.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| kbd | Kabardian | Northwest Caucasian | Cyrl | common_voice_25 | 246.0 | 24.0 | 13.1 | 13.1 | 272.2 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| lv | Latvian | Indo-European (Baltic) | Latn | common_voice_25 | 244.5 | 19.7 | 10.5 | 10.5 | 265.4 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| mhr | Meadow Mari | Uralic (Mari) | Cyrl | common_voice_25 | 242.6 | 239.5 | 18.8 | 19.5 | 280.9 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| jv | Javanese | Austronesian (Malayo-Polynesian) | Latn | slr35_javanese | 236.8 | 0.0 | 29.6 | 29.6 | 296.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ba | Bashkir | Turkic (Kipchak) | Cyrl | common_voice_25 | 223.0 | 146.5 | 17.9 | 17.9 | 258.8 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ru | Russian | Indo-European (Slavic) | Cyrl | common_voice_25 | 222.4 | 38.7 | 14.8 | 14.8 | 251.9 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| zh-CN | Chinese (Mandarin) | Sino-Tibetan (Sinitic) | Hans | common_voice_25 | 212.3 | 37.3 | 13.4 | 13.4 | 239.1 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| yue | Cantonese | Sino-Tibetan (Sinitic) | Hant | common_voice_25 | 199.4 | 8.2 | 5.6 | 5.6 | 210.7 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ta | Tamil | Dravidian | Taml | common_voice_25 | 192.9 | 79.9 | 20.9 | 21.0 | 234.8 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| bn | Bengali | Indo-European (Indo-Aryan) | Beng | slr53_bengali | 183.2 | 0.0 | 22.9 | 22.9 | 229.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| si | Sinhala | Indo-European (Indo-Aryan) | Sinh | slr52_sinhala | 179.2 | 0.0 | 22.4 | 22.4 | 224.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| pt | Portuguese | Indo-European (Romance) | Latn | common_voice_25 | 164.8 | 26.9 | 11.2 | 11.2 | 187.3 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ab | Abkhaz | Northwest Caucasian | Cyrl | common_voice_25 | 164.1 | 148.8 | 21.6 | 21.7 | 207.4 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| pl | Polish | Indo-European (Slavic) | Latn | common_voice_25 | 151.0 | 32.3 | 12.8 | 12.8 | 176.6 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| th | Thai | Kra-Dai (Tai) | Thai | common_voice_25 | 147.5 | 38.4 | 12.9 | 12.9 | 173.3 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ne | Nepali | Indo-European (Indo-Aryan) | Deva | slr54_nepali | 132.0 | 0.0 | 16.5 | 16.5 | 165.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ka | Georgian | Kartvelian | Geor | common_voice_25 | 130.3 | 89.7 | 18.6 | 18.7 | 167.5 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ckb | Central Kurdish | Indo-European (Iranian) | Arab | common_voice_25 | 124.8 | 9.0 | 6.1 | 6.1 | 137.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| is | Icelandic | Indo-European (Germanic) | Latn | slr112_samromur | 116.0 | 0.0 | 14.5 | 14.5 | 145.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| cy | Welsh | Indo-European (Celtic) | Latn | common_voice_25 | 109.3 | 11.0 | 7.4 | 7.4 | 124.1 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| tr | Turkish | Turkic (Oghuz) | Latn | common_voice_25 | 104.0 | 43.6 | 12.6 | 12.6 | 129.2 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| nl | Dutch | Indo-European (Germanic) | Latn | common_voice_25 | 96.5 | 56.3 | 14.9 | 14.9 | 126.2 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| zh-HK | — | — | — | common_voice_25 | 95.6 | 9.7 | 6.5 | 6.5 | 108.5 | no | same language as zh-CN, which has more trainable audio |
| hu | Hungarian | Uralic (Ugric) | Latn | common_voice_25 | 92.6 | 91.4 | 19.9 | 20.0 | 132.6 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| uk | Ukrainian | Indo-European (Slavic) | Cyrl | common_voice_25 | 74.8 | 35.6 | 13.4 | 13.4 | 101.6 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| uz | Uzbek | Turkic (Karluk) | Latn | common_voice_25 | 72.5 | 56.5 | 14.2 | 14.3 | 101.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| zh-TW | — | — | — | common_voice_25 | 70.1 | 6.9 | 4.8 | 4.8 | 79.7 | no | same language as zh-CN, which has more trainable audio |
| ar | Arabic | Afro-Asiatic (Semitic) | Arab | common_voice_25 | 67.9 | 33.4 | 11.8 | 12.1 | 91.9 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ur | Urdu | Indo-European (Indo-Aryan) | Arab | common_voice_25 | 67.8 | 8.6 | 6.0 | 6.0 | 79.7 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| bo | Tibetan | Sino-Tibetan (Bodish) | Tibt | slr124_tibetan | 67.5 | 0.0 | 8.4 | 8.4 | 84.3 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| kmr | Northern Kurdish | Indo-European (Iranian) | Latn | common_voice_25 | 66.0 | 6.5 | 4.8 | 4.8 | 75.7 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| fy-NL | West Frisian | Indo-European (Germanic) | Latn | common_voice_25 | 61.9 | 5.3 | 4.3 | 4.3 | 70.4 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ady | Adyghe | Northwest Caucasian | Cyrl | common_voice_25 | 60.7 | 6.2 | 4.9 | 4.9 | 70.5 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| cs | Czech | Indo-European (Slavic) | Latn | common_voice_25 | 57.6 | 27.6 | 11.7 | 11.7 | 81.1 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| hy | Armenian | Indo-European (Armenian) | Armn | slr160_armenian | 56.0 | 0.0 | 7.0 | 7.0 | 70.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| nso | Sepedi | Atlantic-Congo (Sotho-Tswana) | Latn | nchlt_sepedi | 50.9 | 50.9 | 2.5 | 2.9 | 0.0 | yes | meets the rule (trainable >= 50.0 h, dev >= 2.0 h, test >= 2.0 h) |
| ts | Xitsonga | Atlantic-Congo (Tswa-Ronga) | Latn | nchlt_xitsonga | 49.8 | 49.8 | 2.9 | 3.6 | 0.0 | yes | below the rule (trainable 49.8 h < 50.0 h); kept for typological coverage; its NCHLT corpus totals about 56 h and the shortfall is in the shipped train split, not in the corpus |
| ve | Tshivenda | Atlantic-Congo (Venda) | Latn | nchlt_tshivenda | 49.6 | 49.6 | 3.6 | 3.1 | 0.0 | yes | below the rule (trainable 49.6 h < 50.0 h); kept for typological coverage; its NCHLT corpus totals about 56 h and the shortfall is in the shipped train split, not in the corpus |
| xh | isiXhosa | Atlantic-Congo (Nguni) | Latn | nchlt_xhosa | 49.4 | 49.4 | 3.8 | 3.1 | 0.0 | yes | below the rule (trainable 49.4 h < 50.0 h); kept for typological coverage; its NCHLT corpus totals about 56 h and the shortfall is in the shipped train split, not in the corpus |
| zu | isiZulu | Atlantic-Congo (Nguni) | Latn | nchlt_zulu | 48.5 | 48.5 | 3.7 | 4.0 | 0.0 | yes | below the rule (trainable 48.5 h < 50.0 h); kept for typological coverage; its NCHLT corpus totals about 56 h and the shortfall is in the shipped train split, not in the corpus |
| sk | — | — | — | common_voice_25 | 42.9 | 11.6 | 6.6 | 7.1 | 56.6 | no | trainable 42.9 h < 50.0 h |
| ko | Korean | Koreanic | Kore | slr40_zeroth_korean | 42.2 | 51.6 | 5.3 | 5.3 | 52.8 | yes | below the rule (trainable 42.2 h < 50.0 h); kept because it is the only open Korean corpus, and Koreanic and Hangul are in the preset only through it; the shipped 1.2 h test is under the evaluation bar, so all 52.8 h are repartitioned |
...
| fi | Finnish | Uralic (Finnic) | Latn | common_voice_25 | 11.1 | 2.7 | 2.3 | 2.3 | 15.8 | yes | below the rule (trainable 11.1 h < 50.0 h); kept because the smaller presets commit to it |
...
| hi | Hindi | Indo-European (Indo-Aryan) | Deva | common_voice_25 | 7.0 | 6.9 | 3.9 | 4.7 | 15.6 | yes | below the rule (trainable 7.0 h < 50.0 h); kept because the smaller presets commit to it |
